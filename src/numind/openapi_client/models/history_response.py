...
class HistoryResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "projectId", "ownerUser", "documentInfo", "result", "createdAt", "updatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": InformationResponse.from_dict(obj["result"]) if obj.get("result") is not None else None,
