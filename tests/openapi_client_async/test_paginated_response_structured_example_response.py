...
class TestPaginatedResponseStructuredExampleResponse(unittest.TestCase):
    """PaginatedResponseStructuredExampleResponse unit test stubs"""
    ...
    def make_instance(
        ...
        """
        Test PaginatedResponseStructuredExampleResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `PaginatedResponseStructuredExampleResponse`
        """
        model = PaginatedResponseStructuredExampleResponse()
        if include_optional:
            return PaginatedResponseStructuredExampleResponse(
                total_count = 56,
                skip = 56,
                per_page = 56,
                items = [
    ...
    def testPaginatedResponseStructuredExampleResponse(self):
        """Test PaginatedResponseStructuredExampleResponse"""
