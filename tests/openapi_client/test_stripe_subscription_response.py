...
class TestStripeSubscriptionResponse(unittest.TestCase):
    """StripeSubscriptionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StripeSubscriptionResponse:
        """
        Test StripeSubscriptionResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `StripeSubscriptionResponse`
        """
        model = StripeSubscriptionResponse()
        if include_optional:
    ...
    def testStripeSubscriptionResponse(self):
        """Test StripeSubscriptionResponse"""
