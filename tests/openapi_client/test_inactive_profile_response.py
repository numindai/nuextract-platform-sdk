...
class TestInactiveProfileResponse(unittest.TestCase):
    """InactiveProfileResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InactiveProfileResponse:
        """
        Test InactiveProfileResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `InactiveProfileResponse`
        """
        model = InactiveProfileResponse()
        if include_optional:
            return InactiveProfileResponse(
                type = 'ai.numind.extract.shared.InactiveProfileResponse'
            )
        else:
            return InactiveProfileResponse(
                type = 'ai.numind.extract.shared.InactiveProfileResponse',
    ...
    def testInactiveProfileResponse(self):
        """Test InactiveProfileResponse"""
