...
class Arr1(BaseModel):
    """
    Arr1
    """ # noqa: E501
    values: Optional[List[InfoNode]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [InfoNode.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj

from numind.openapi_client.models.info_node import InfoNode
# TODO: Rewrite to not use raise_errors
Arr1.model_rebuild(raise_errors=False)
