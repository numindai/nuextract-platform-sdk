...
class TestStripePortalResponse(unittest.TestCase):
    """StripePortalResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StripePortalResponse:
        """
        Test StripePortalResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `StripePortalResponse`
        """
        model = StripePortalResponse()
        if include_optional:
    ...
    def testStripePortalResponse(self):
        """Test StripePortalResponse"""
