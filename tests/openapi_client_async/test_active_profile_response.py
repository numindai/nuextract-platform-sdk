...
class TestActiveProfileResponse(unittest.TestCase):
    """ActiveProfileResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveProfileResponse:
        """
        Test ActiveProfileResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `ActiveProfileResponse`
        """
        model = ActiveProfileResponse()
        if include_optional:
            return ActiveProfileResponse(
                plan_id = '',
                current_billing_period = numind.openapi_client_async.models.billing_period.BillingPeriod(
                    from = '', 
                    to = '', ),
                input_feature_card = numind.openapi_client_async.models.feature_card_response.FeatureCardResponse(
                    usage = 56, 
                    free_tokens = 56, 
                    price = 1.337, ),
                output_feature_card = numind.openapi_client_async.models.feature_card_response.FeatureCardResponse(
                    usage = 56, 
                    free_tokens = 56, 
                    price = 1.337, ),
    ...
    def testActiveProfileResponse(self):
        """Test ActiveProfileResponse"""
