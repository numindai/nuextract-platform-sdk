    ...
    def make_instance(self, include_optional) -> ActiveProfileResponse:
        ...
        if include_optional:
            return ActiveProfileResponse(
                plan_id = '',
                current_billing_period = numind.openapi_client.models.billing_period.BillingPeriod(
                    from = '', 
                    to = '', ),
                input_feature_card = numind.openapi_client.models.feature_card_response.FeatureCardResponse(
                    usage = 56, 
                    free_tokens = 56, 
                    price = 1.337, ),
                output_feature_card = numind.openapi_client.models.feature_card_response.FeatureCardResponse(
                    usage = 56, 
                    free_tokens = 56, 
                    price = 1.337, ),
