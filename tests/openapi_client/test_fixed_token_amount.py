...
class TestFixedTokenAmount(unittest.TestCase):
    """FixedTokenAmount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FixedTokenAmount:
        """
        Test FixedTokenAmount
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `FixedTokenAmount`
        """
        model = FixedTokenAmount()
        if include_optional:
            return FixedTokenAmount(
                amount = 56,
                type = 'fixed-amount'
            )
        else:
