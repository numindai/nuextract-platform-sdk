...
class TestUsageItemResponse(unittest.TestCase):
    """UsageItemResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageItemResponse:
        """
        Test UsageItemResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `UsageItemResponse`
        """
        model = UsageItemResponse()
        if include_optional:
            return UsageItemResponse(
                api_usage = numind.models.usage_metrics_response.UsageMetricsResponse(
                    inference_count = 56, 
                    input_token_count = 56, 
                    output_token_count = 56, ),
                interface_usage = numind.models.usage_metrics_response.UsageMetricsResponse(
                    inference_count = 56, 
                    input_token_count = 56, 
                    output_token_count = 56, )
            )
    ...
    def testUsageItemResponse(self):
        """Test UsageItemResponse"""
