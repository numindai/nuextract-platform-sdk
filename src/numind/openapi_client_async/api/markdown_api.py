...
class MarkdownApi:
    ...
    @validate_call
    async def post_api_markdown_infer_async(
        self,
        ...
        """  # noqa: E501
        _param = self._post_api_markdown_infer_async_serialize(
            file=file,
    ...
    @validate_call
    async def post_api_markdown_infer_async_with_http_info(
        self,
        file: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        temperature: Annotated[
            Optional[
    ...
    @validate_call
    async def post_api_markdown_infer_async_without_preload_content(
        self,
        file: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        temperature: Annotated[
            Optional[
    ...
    def _post_api_markdown_infer_async_serialize(
        self,
        file,
        temperature,
        rasterization_dpi,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/markdown/infer-async",
