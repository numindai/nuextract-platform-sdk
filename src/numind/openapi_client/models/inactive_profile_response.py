...
class InactiveProfileResponse(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(["ai.numind.extract.shared.InactiveProfileResponse"]):
            raise ValueError(
                "must be one of enum values ('ai.numind.extract.shared.InactiveProfileResponse')"
            )
        return value
