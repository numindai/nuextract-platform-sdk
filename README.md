...
*BillingApi* | [**get_api_billing_plans**](docs/BillingApi.md#get_api_billing_plans) | **GET** /api/billing/plans | 
*BillingApi* | [**get_api_billing_plans_plankey**](docs/BillingApi.md#get_api_billing_plans_plankey) | **GET** /api/billing/plans/{planKey} | 
*BillingApi* | [**get_api_billing_profile**](docs/BillingApi.md#get_api_billing_profile) | **GET** /api/billing/profile | 
*BillingApi* | [**post_api_billing_connect_to_stripe**](docs/BillingApi.md#post_api_billing_connect_to_stripe) | **POST** /api/billing/connect-to-stripe | 
*BillingApi* | [**post_api_billing_restore_subscription**](docs/BillingApi.md#post_api_billing_restore_subscription) | **POST** /api/billing/restore-subscription | 
*BillingApi* | [**post_api_billing_stripe_portal**](docs/BillingApi.md#post_api_billing_stripe_portal) | **POST** /api/billing/stripe-portal | 
*BillingApi* | [**post_api_billing_subscribe**](docs/BillingApi.md#post_api_billing_subscribe) | **POST** /api/billing/subscribe | 
...
### Documentation For Models
 ...
 - [BillingProfileResponse](docs/BillingProfileResponse.md)
 ...
 - [StripePortalRequest](docs/StripePortalRequest.md)
 - [StripePortalResponse](docs/StripePortalResponse.md)
 - [StripeSubscriptionRequest](docs/StripeSubscriptionRequest.md)
