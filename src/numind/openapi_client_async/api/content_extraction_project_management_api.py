...
class ContentExtractionProjectManagementApi:
    ...
    @validate_call
    async def delete_api_content_extraction_contentprojectid(
        self,
    ...
    @validate_call
    async def delete_api_content_extraction_contentprojectid_with_http_info(
        self,
        content_project_id: Annotated[
            StrictStr,
            Field(description="Unique content extraction project identifier."),
    ...
    @validate_call
    async def delete_api_content_extraction_contentprojectid_without_preload_content(
        self,
        content_project_id: Annotated[
            StrictStr,
            Field(description="Unique content extraction project identifier."),
