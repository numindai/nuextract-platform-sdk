...
class StructuredExtractionProjectManagementApi:
    ...
    @validate_call
    async def delete_api_structured_extraction_structuredprojectid(
        self,
    ...
    @validate_call
    async def delete_api_structured_extraction_structuredprojectid_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def delete_api_structured_extraction_structuredprojectid_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_thumbnail(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_thumbnail_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_thumbnail_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def patch_api_structured_extraction_structuredprojectid(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def patch_api_structured_extraction_structuredprojectid_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def patch_api_structured_extraction_structuredprojectid_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def patch_api_structured_extraction_structuredprojectid_settings(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
        ...
        patch_api_structured_extraction_structuredprojectid_settings
         ...
         Update the settings of an existing **Structured Extraction Project**.  Omitted fields keep their current value. Set `randomSeed` to a string containing a 64-bit integer for a fixed seed, or to `\"random\"` to generate a random seed for each inference.   #### Error Responses: `404 Not Found` - If a **Project** with the specified `projectId` does not exist.  `403 Forbidden` - If the user does not have permission to update this **Project**.  `403 Locked` - If the **Project** is locked.
    ...
    @validate_call
    async def patch_api_structured_extraction_structuredprojectid_settings_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def patch_api_structured_extraction_structuredprojectid_settings_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_duplicate(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_duplicate_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_duplicate_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_lock(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_lock_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_lock_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_reset_settings(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
        ...
        post_api_structured_extraction_structuredprojectid_reset_settings
         ...
         Reset the settings of an existing **Structured Extraction Project** to their default values.  Default values are:   Setting | Default | -----------|---------|  `temperature` | 0.6 |  `rasterizationDPI` | 170|  `maxOutputTokens` | 0 (no limit) |  `randomSeed` | 2022 (-9223372036854775808 to 9223372036854775807, or `random`) |  `degradedMode`  (deprecated) | Reject|  `maxExampleTokenNumber` (former `maxTokensSmartExample`) | 90000|  #### Error Responses: `404 Not Found` - If a **Project** with the specified `projectId` does not exist.  `403 Forbidden` - If the user does not have permission to update this **Project**.  `403 Locked` - If the **Project** is locked.
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_reset_settings_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_reset_settings_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_share(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_share_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_share_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_unlock(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_unlock_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_unlock_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_unshare(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_unshare_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_unshare_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
