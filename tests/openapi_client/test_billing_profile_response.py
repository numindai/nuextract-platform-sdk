...
class TestBillingProfileResponse(unittest.TestCase):
    """BillingProfileResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BillingProfileResponse:
        """
        Test BillingProfileResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `BillingProfileResponse`
        """
        model = BillingProfileResponse()
        if include_optional:
            return BillingProfileResponse(
                ...
                overage = 56,
                subscriptions = [
                    numind.openapi_client.models.subscription.Subscription(
                        plan_id = '', 
                        plan_version = 56, 
                        active_from = '', 
                        active_to = '', 
    ...
    def testBillingProfileResponse(self):
        """Test BillingProfileResponse"""
