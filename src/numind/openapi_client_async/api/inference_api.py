...
class InferenceApi:
    ...
    @validate_call
    async def post_api_content_extraction_contentprojectid_jobs_document_documentid(
        self,
    ...
    @validate_call
    async def post_api_content_extraction_contentprojectid_jobs_document_documentid_with_http_info(
        self,
        content_project_id: Annotated[
            StrictStr,
            Field(description="Unique content extraction project identifier."),
    ...
    @validate_call
    async def post_api_content_extraction_contentprojectid_jobs_document_documentid_without_preload_content(
        self,
        content_project_id: Annotated[
            StrictStr,
            Field(description="Unique content extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_jobs_document_documentid(
        self,
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_jobs_document_documentid_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_jobs_document_documentid_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
