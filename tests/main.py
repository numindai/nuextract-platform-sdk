...
if __name__ == "__main__":
    ...
    projects = client.get_api_reference_projects(shared=False)
    ...
    output_schema = client.post_api_reference_projects_projectid_infer_text(project_id, text_request=text_request)'''

    # Infer with file
    input_file_path = Path("vacation.docx")
