...
class TestFeatureCardResponse(unittest.TestCase):
    """FeatureCardResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeatureCardResponse:
        """
        Test FeatureCardResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `FeatureCardResponse`
        """
        model = FeatureCardResponse()
        if include_optional:
    ...
    def testFeatureCardResponse(self):
        """Test FeatureCardResponse"""
