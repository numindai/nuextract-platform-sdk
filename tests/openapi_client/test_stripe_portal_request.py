...
class TestStripePortalRequest(unittest.TestCase):
    """StripePortalRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StripePortalRequest:
        """
        Test StripePortalRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `StripePortalRequest`
        """
        model = StripePortalRequest()
        if include_optional:
            return StripePortalRequest(
                organization_id = '',
                return_url = ''
            )
        else:
    ...
    def testStripePortalRequest(self):
        """Test StripePortalRequest"""
