...
class TestStripeSubscriptionRequest(unittest.TestCase):
    """StripeSubscriptionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StripeSubscriptionRequest:
        """
        Test StripeSubscriptionRequest
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `StripeSubscriptionRequest`
        """
        model = StripeSubscriptionRequest()
        if include_optional:
    ...
    def testStripeSubscriptionRequest(self):
        """Test StripeSubscriptionRequest"""
