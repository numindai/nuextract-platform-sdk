...
class TestUnlimitedTokenAmount(unittest.TestCase):
    """UnlimitedTokenAmount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnlimitedTokenAmount:
        """
        Test UnlimitedTokenAmount
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included
        """
        # uncomment below to create an instance of `UnlimitedTokenAmount`
        """
        model = UnlimitedTokenAmount()
        if include_optional:
            return UnlimitedTokenAmount(
                type = 'unlimited'
            )
        else:
            return UnlimitedTokenAmount(
    ...
    def testUnlimitedTokenAmount(self):
        """Test UnlimitedTokenAmount"""
