...
class StructuredExtractionExamplesApi:
    ...
    @validate_call
    async def delete_api_structured_extraction_structuredprojectid_examples_structuredexampleid(
        self,
    ...
    @validate_call
    async def delete_api_structured_extraction_structuredprojectid_examples_structuredexampleid_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def delete_api_structured_extraction_structuredprojectid_examples_structuredexampleid_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_examples(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_examples_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_examples_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_examples_structuredexampleid(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_examples_structuredexampleid_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def get_api_structured_extraction_structuredprojectid_examples_structuredexampleid_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_examples(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_examples_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def post_api_structured_extraction_structuredprojectid_examples_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def put_api_structured_extraction_structuredprojectid_examples_structuredexampleid(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def put_api_structured_extraction_structuredprojectid_examples_structuredexampleid_with_http_info(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
    ...
    @validate_call
    async def put_api_structured_extraction_structuredprojectid_examples_structuredexampleid_without_preload_content(
        self,
        structured_project_id: Annotated[
            StrictStr,
            Field(description="Unique structured extraction project identifier."),
