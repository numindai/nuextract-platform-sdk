...
class TokenResponse(BaseModel):
    ...
    refresh_expires_in: Optional[StrictInt] = Field(default=None, alias="refreshExpiresIn")
    __properties: ClassVar[List[str]] = ["token", "expiresIn", "refreshToken", "refreshExpiresIn"]
