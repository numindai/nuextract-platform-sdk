...
from numind.openapi_client.models.stripe_subscription_request import (
    StripeSubscriptionRequest,
)
from numind.openapi_client.models.stripe_subscription_response import (
...
class BillingApi:
    ...
    def get_api_billing_plans(
        ...
        """
        _param = self._get_api_billing_plans_serialize(
    ...
    @validate_call
    def get_api_billing_plans_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_api_billing_plans_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_api_billing_plans_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def get_api_billing_plans_plankey(
        self,
        plan_key: Annotated[StrictStr, Field(description="Plan identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param plan_key: Plan identifier (required)
        :type plan_key: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        :return: Returns the result object.
        """
        _param = self._get_api_billing_plans_plankey_serialize(
            plan_key=plan_key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_api_billing_plans_plankey_with_http_info(
        self,
        plan_key: Annotated[StrictStr, Field(description="Plan identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_api_billing_plans_plankey_without_preload_content(
        self,
        plan_key: Annotated[StrictStr, Field(description="Plan identifier")],
        _request_timeout: Union[
            None,
    ...
    def _get_api_billing_plans_plankey_serialize(
        self,
        plan_key,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/billing/plans/{planKey}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_api_billing_profile(
        ...
        :return: Returns the result object.
        """
        _param = self._get_api_billing_profile_serialize(
    ...
    @validate_call
    def get_api_billing_profile_with_http_info(
        self,
        organization_id: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BillingProfileResponse]:
        """
        get_api_billing_profile
    ...
    @validate_call
    def get_api_billing_profile_without_preload_content(
        self,
        organization_id: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_api_billing_profile_serialize(
        self,
        organization_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/billing/profile",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_api_billing_connect_to_stripe(
        self,
        stripe_subscription_request: StripeSubscriptionRequest,
        organization_id: Annotated[
            Optional[StrictStr],
            Field(
                description="Optional organization identifier. If provided, the request will be associated with this organization. Otherwise, the request will be associated with the authenticated user.         "
            ),
        ] = None,
        _request_timeout: Union[
            None,
        ...
        :param stripe_subscription_request: (required)
        :type stripe_subscription_request: StripeSubscriptionRequest
        :param organization_id: Optional organization identifier. If provided, the request will be associated with this organization. Otherwise, the request will be associated with the authenticated user.
        :type organization_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        :return: Returns the result object.
        """  # noqa: E501
        _param = self._post_api_billing_connect_to_stripe_serialize(
            stripe_subscription_request=stripe_subscription_request,
            organization_id=organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "StripeSubscriptionResponse",
            "400": "str",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    @validate_call
    def post_api_billing_connect_to_stripe_with_http_info(
        self,
        stripe_subscription_request: StripeSubscriptionRequest,
        organization_id: Annotated[
            Optional[StrictStr],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StripeSubscriptionResponse]:
        """
        post_api_billing_connect_to_stripe
    ...
    @validate_call
    def post_api_billing_connect_to_stripe_without_preload_content(
        self,
        stripe_subscription_request: StripeSubscriptionRequest,
        organization_id: Annotated[
            Optional[StrictStr],
    ...
    def _post_api_billing_connect_to_stripe_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if stripe_subscription_request is not None:
            _body_params = stripe_subscription_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/billing/connect-to-stripe",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_api_billing_restore_subscription(
        self,
        organization_id: Annotated[
            Optional[StrictStr],
            Field(
        ...
        :return: Returns the result object.
        """  # noqa: E501
        _param = self._post_api_billing_restore_subscription_serialize(
            organization_id=organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_api_billing_restore_subscription_with_http_info(
        self,
        organization_id: Annotated[
            Optional[StrictStr],
            Field(
    ...
    @validate_call
    def post_api_billing_restore_subscription_without_preload_content(
        self,
        organization_id: Annotated[
            Optional[StrictStr],
            Field(
    ...
    def _post_api_billing_restore_subscription_serialize(
        self,
        organization_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/billing/restore-subscription",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_api_billing_stripe_portal(
        self,
        stripe_portal_request: StripePortalRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param stripe_portal_request: (required)
        :type stripe_portal_request: StripePortalRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        :return: Returns the result object.
        """
        _param = self._post_api_billing_stripe_portal_serialize(
            stripe_portal_request=stripe_portal_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def post_api_billing_stripe_portal_with_http_info(
        self,
        stripe_portal_request: StripePortalRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StripePortalResponse]:
        """
        post_api_billing_stripe_portal
    ...
    @validate_call
    def post_api_billing_stripe_portal_without_preload_content(
        self,
        stripe_portal_request: StripePortalRequest,
        _request_timeout: Union[
            None,
    ...
    def _post_api_billing_stripe_portal_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if stripe_portal_request is not None:
            _body_params = stripe_portal_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/billing/stripe-portal",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_api_billing_subscribe(
        self,
        ...
        :return: Returns the result object.
        """  # noqa: E501
        _param = self._post_api_billing_subscribe_serialize(
    ...
    @validate_call
    def post_api_billing_subscribe_with_http_info(
        self,
        subscription_request: SubscriptionRequest,
        organization_id: Annotated[
            Optional[StrictStr],
    ...
    @validate_call
    def post_api_billing_subscribe_without_preload_content(
        self,
        subscription_request: SubscriptionRequest,
        organization_id: Annotated[
            Optional[StrictStr],
    ...
    def _post_api_billing_subscribe_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/billing/subscribe",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
