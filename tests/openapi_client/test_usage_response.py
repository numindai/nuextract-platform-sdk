    ...
    def make_instance(self, include_optional) -> UsageResponse:
        ...
        if include_optional:
            return UsageResponse(
                period = numind.models.date_range.DateRange(
                    from = '', 
                    to = '', ),
                template_usage = numind.models.usage_item_response.UsageItemResponse(
                    api_usage = null, 
                    interface_usage = null, ),
                structured_usage = numind.models.usage_item_response.UsageItemResponse(
                    api_usage = null, 
                    interface_usage = null, ),
                content_usage = numind.models.usage_item_response.UsageItemResponse(
                    api_usage = null, 
                    interface_usage = null, )
            )
        else:
