...
class Arr(BaseModel):
    ...
    Arr
    """ # noqa: E501
    var_schema: SchemaNode = Field(alias="schema")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schema": SchemaNode.from_dict(obj["schema"]) if obj.get("schema") is not None else None
        })
        return _obj

from numind.openapi_client.models.schema_node import SchemaNode
# TODO: Rewrite to not use raise_errors
Arr.model_rebuild(raise_errors=False)
