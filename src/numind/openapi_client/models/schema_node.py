...
class SchemaNode(BaseModel):
    ...
    # data type: Arr
    oneof_schema_1_validator: Arr | None = None
    # data type: object
    oneof_schema_2_validator: dict[str, Any] | None = None
    # data type: object
    oneof_schema_3_validator: dict[str, Any] | None = None
    # data type: Enum
    oneof_schema_4_validator: Enum | None = None
    # data type: object
    oneof_schema_5_validator: dict[str, Any] | None = None
    # data type: MultiEnum
    oneof_schema_6_validator: MultiEnum | None = None
    # data type: object
    oneof_schema_7_validator: dict[str, Any] | None = None
    # data type: Obj
    oneof_schema_8_validator: Obj | None = None
    # data type: object
    oneof_schema_9_validator: dict[str, Any] | None = None
    # data type: object
    oneof_schema_10_validator: dict[str, Any] | None = None
    actual_instance: Arr | Enum | MultiEnum | Obj | object | None = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in SchemaNode with oneOf schemas: Arr, Enum, MultiEnum, Obj, object. Details: "
                + ", ".join(error_messages)
            )
        if match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in SchemaNode with oneOf schemas: Arr, Enum, MultiEnum, Obj, object. Details: "
                + ", ".join(error_messages)
            )
        return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when deserializing the JSON string into SchemaNode with oneOf schemas: Arr, Enum, MultiEnum, Obj, object. Details: "
                + ", ".join(error_messages)
            )
        if match == 0:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into SchemaNode with oneOf schemas: Arr, Enum, MultiEnum, Obj, object. Details: "
                + ", ".join(error_messages)
            )
        return instance
    ...
    def to_dict(self) -> dict[str, Any] | Arr | Enum | MultiEnum | Obj | object | None:
