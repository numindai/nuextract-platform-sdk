...
create_structured_project_request_instance = CreateStructuredProjectRequest.from_json(
    json
)
...
create_structured_project_request_dict = (
    create_structured_project_request_instance.to_dict()
)
# create an instance of CreateStructuredProjectRequest from a dict
create_structured_project_request_from_dict = CreateStructuredProjectRequest.from_dict(
    create_structured_project_request_dict
)
```
