...
class BillingProfileResponse(BaseModel):
    ...
    can_display_invoices: StrictBool = Field(alias="canDisplayInvoices")
        ...
        _obj = cls.model_validate(
            {
                ...
                "subscriptions": [
                    Subscription.from_dict(_item) for _item in obj["subscriptions"]
                ]
                if obj.get("subscriptions") is not None
                else None,
                "canDisplayInvoices": obj.get("canDisplayInvoices"),
            }
        )
        return _obj
