...
update_structured_project_request_instance = UpdateStructuredProjectRequest.from_json(
    json
)
...
update_structured_project_request_dict = (
    update_structured_project_request_instance.to_dict()
)
# create an instance of UpdateStructuredProjectRequest from a dict
update_structured_project_request_from_dict = UpdateStructuredProjectRequest.from_dict(
    update_structured_project_request_dict
)
```
