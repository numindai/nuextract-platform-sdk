...
class UsageMetricsResponse(BaseModel):
    ...
    inference_count: StrictInt = Field(
        description="Inference count", alias="inferenceCount"
    )
    input_token_count: StrictInt = Field(
        description="Input token count", alias="inputTokenCount"
    )
    output_token_count: StrictInt = Field(
        description="Output token count", alias="outputTokenCount"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "inferenceCount": obj.get("inferenceCount"),
